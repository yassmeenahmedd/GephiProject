...
=====================
PageRank, Betweenness Centrality, and other link-analysis techniques., and Eigenvector centrality.
...
def render_centrality_comparison(
    ...
    """
    measure_keys   = ["pagerank", "betweenness", "eigenvector"]
    measure_labels = ["PageRank", "Betweenness", "Eigenvector"]
